...
<html>
  ...
  <body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation" >
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a href="javascript:void(0)" onclick="openLoginModal();"><span class="glyphicon glyphicon-user"></span> 登录</a></li>
                <li><a href="javascript:void(0)" onclick="openRegisterModal();"><span class="glyphicon glyphicon-log-in"></span> 注册</a></li>
            </ul>
        </div>
    </nav>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <div class="forgot register-footer" style="display:none">
                            <span>已有账号？</span>
                            <a href="javascript: showLoginForm();">直接登录</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div style="padding-top: 100px">
        <div id="section-1" style="padding-top: 50px">第一部分</div>
        ...
        <hr>
        <div id="section-2" style="padding-top: 50px">第二部分</div>
        ...
        <hr>
        <div id="section-3" style="padding-top: 50px">第三部分</div>
        ...
        <hr>
        <div id="section-4" style="padding-top: 50px">第四部分</div>
        ...
        <hr>
        <div id="section-5" style="padding-top: 50px">第五部分</div>
